...
- `assets/audio/heritage-theme.mp3` — CHƯA CÓ FILE: hook nhạc nền trang Triển lãm đã sẵn, thả file mp3 vào là chạy
...
5. **Nhạc nền**: thả file vào `assets/audio/heritage-theme.mp3`.
